...
# Read Files -> Read Columns -> Create a Singular Dataframe with all the SPK columns for all animals for all
# trajectories -> Calculate movement onset and offset -> Calculate Metrics